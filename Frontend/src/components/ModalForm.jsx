  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        ...
        <DialogContent dividers sx={{ background: "#2d2d2d", color: "white", border: 0 }}>
            ...
            {["name", "phone", "email", "zip", "message"].map((field) => (
              <TextField
                ...
                label={
                  field === "zip"
                    ? "ZIP Code"
                    : field.charAt(0).toUpperCase() + field.slice(1).replace("email", "Email Address").replace("phone", "Phone Number")
                }
                variant="filled"
                fullWidth
        ...
        <DialogActions sx={{ justifyContent: "center", pb: 2, background: "#2d2d2d", border: 0 }}>
          <Button
            type="submit"
            variant="contained"
            size="large"
